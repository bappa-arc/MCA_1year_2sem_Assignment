...
public class Q14 {
    ...
    public static void main(String[] args) {
        ...
        try {
            // Q14: Write first 10 Fibonacci numbers to Fibo.txt
            ...
            //Read Fibo.txt and append next Fibonacci numbers (<250)
            ...
            // Q16: Generate binary file Fibo.bin from Fibo.txt
            Scanner readTxt = new Scanner(new File("Fibo.txt"));
            DataOutputStream dos =
                    new DataOutputStream(new FileOutputStream("Fibo.bin"));
